...
<body>
    ...
    <main class="container my-5">
        ...
        <section id="inicio" class="my-5">
            <div class="inicio-fundo d-flex justify-content-between align-items-center">
                <div class="esquerda-conteudo">
                    <h1 class="display-4 text-white fst-italic fw-bold">Boas-vindas ao</h1>
        ...
        <section id="cocorico" class="my-5 pt-6 secao-cocorico" tabindex="0" aria-label="Seção explicativa sobre o programa Cocórico">
            <div class="container d-flex align-items-center ">
                <div class="col-4 d-flex justify-content-center ">
                    <img src="img/image (1).png" class="rounded-pill" width="273" height="331" loading="lazy">
                </div>
                <div class="col-5">
                    <h2>O que é Cocórico?</h2>
                    <p class="p-2">O Cocórico foi um programa infantil brasileiro da TV Cultura, 
                        exibido de 1996 a 2000. Ele apresentava personagens como o galo Zé Cocoroca e seus amigos, 
                        que moravam em uma fazenda e viviam aventuras educativas sobre amizade, natureza e vida rural. 
                        Com seu conteúdo lúdico e musical, o programa conquistou o público infantil e se tornou um marco na TV brasileira.</p>
                </div>
            </div>
        </section>
